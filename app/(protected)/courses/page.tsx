...
import { getCourses, getTopics, getTeachers, type Course } from "./_actions/course-actions"
            ...
            <Link key={course.id} href={`/courses/${course.slug}`}>
              <Card className="p-4 h-full hover:shadow-lg transition-shadow">
                ...
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-sm text-muted-foreground">By {course.author.name}</span>
