  ...
  try {
    ...
    const statistics = await prisma.course.upsert({
      ...
      create: {
        ...
        description: "An introduction to statistics and probability. This course covers descriptive statistics, probability distributions, hypothesis testing, and regression analysis.",
          ...
          create: [
            {
              ...
              examples: "## Example: Data Collection\n\nLet's look at how to collect and organize data...",
              order: 1
            },
            {
              ...
              examples: "## Example: Coin Flips\n\nLet's calculate the probability of getting heads in a fair coin flip...",
              order: 2
            }
          ]
        }
    ...
    const discreteMath = await prisma.course.upsert({
      ...
      create: {
        ...
        description: "A comprehensive course on discrete mathematics covering logic, set theory, combinatorics, graph theory, and number theory.",
          ...
          create: [
            {
              ...
              theory: "# Logic and Proofs\n\nLogic is the foundation of mathematical reasoning...",
              examples: "## Example: Truth Tables\n\nLet's create truth tables for basic logical operations...",
              order: 1
            },
            {
              title: "Set Theory",
              ...
              examples: "## Example: Set Operations\n\nLet's practice union and intersection operations...",
              order: 2
            }
          ]
        }
    ...
    await seedEnrollments(mainStudent.id, [calculus1, linearAlgebra, statistics, discreteMath])
    ...
    await seedEnrollments(studentUsers[3].id, [calculus1, linearAlgebra, statistics, discreteMath])
